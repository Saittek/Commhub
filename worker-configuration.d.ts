/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f911ff41d8feb898024825e4777cdd80)
// Runtime types generated with workerd@1.20260701.1 2026-07-04 nodejs_compat_v2
interface __BaseEnv_Env {
	DB: D1Database;
	JWT_SECRET: string;
	VOICE_ROOM: DurableObjectNamespace<import("./src/worker/index").VoiceRoom>;
	TEXT_ROOM: DurableObjectNamespace<import("./src/worker/index").TextRoom>;
	ATTACHMENTS: R2Bucket;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "VoiceRoom" | "TextRoom";
	}
